...
@php($week_days = ['Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo'])
    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg space-y-6">
        ...
        <div class="max-w-xl pl-8">
            ...
            <li>
                ...
                />
                <label class="form-check-label inline-block text-gray-800 dark:text-gray-200" for="toggle-{{ $loop->index }}">{{ $week_days[$loop->index] }}</label>
            </li>
            @endforeach
            </ul>
        </div>
